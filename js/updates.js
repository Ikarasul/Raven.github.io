// updates.js - Manages Homepage Updates & Logs
    ...
    system: [
        {
            ...
            icon: 'cloud-sun',
            color: 'cyan', // Ensure 'sky' works, otherwise 'blue' or 'cyan'
            badge: 'ใหม่'
        },
        {
            type: 'update',
...
function renderUpdatesWidget() {
    ...
    // Refresh icons since we injected new HTML
...
// Helper to generate a log item (Full view)
...
document.addEventListener('DOMContentLoaded', () => {
    renderUpdatesWidget();
    renderUpdatesModal();
    // Re-run language update to catch the new injected elements
